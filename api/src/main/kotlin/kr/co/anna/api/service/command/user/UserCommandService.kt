...
class UserCommandService(
    ...
    fun createUser(signUpIn: SignUpIn) {
        try {
     ...
     * 비밀번호 찾기 등
     */
    fun findQuestion(userId: String, email: String): String? {
        return userRepository.getByUserIdAndEmail(userId, email).question()
    }

    fun answerPassword(userId: String, email: String, answer: String): Boolean {
        val dbUser = userRepository.getByUserIdAndEmail(userId, email)
